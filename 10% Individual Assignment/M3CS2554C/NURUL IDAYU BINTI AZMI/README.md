...
Capacity testing helps determine the **maximum number of users a system can handle** before performance starts to degrade, such as longer response times or failed requests.
