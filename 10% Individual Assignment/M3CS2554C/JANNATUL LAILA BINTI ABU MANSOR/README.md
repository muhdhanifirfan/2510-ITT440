...
<p align="justify"> Justification: While GTMetrix is not a traditional load-testing tool like Apache JMeter that can simulate thousands of concurrent virtual users, it was chosen for this stress test for several reasons. </p>
<p align="justify">  </p>
 <hr> <!-- This creates a horizontal divider line -->
